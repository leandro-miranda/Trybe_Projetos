...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-022-a-project-recipes-app.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-022-a-project-recipes-app`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-022-a-project-recipes-app/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-022-a-project-recipes-app/pulls) e confira que o seu _Pull Request_ está criado
