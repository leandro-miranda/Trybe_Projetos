# Boas vindas ao repositório do projeto App de Delivery!
  ...
  **Neste projeto, seu grupo deve desenvolver um app de delivery para uma distribuidora de bebidas. Veja abaixo o contexto da entrega que deve ser feita:**
  ...
  Sua equipe, que já possui uma boa experiência com desenvolvimento, em pouco tempo apresentou um [protótipo](#construção-do-front-end) e um [Diagrama de ER](./assets/readme/eer.png) conforme imagem:
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-022-a-project-delivery-app.git`.
...
<details>
  ...
  **Observação:** nesse projeto, utilizamos o gerenciador de processos `pm2`. 
...
Um bom exercício aqui é utilizar seu aprendizado de [`Heroku`](https://app.betrybe.com/learn/course/5e938f69-6e32-43b3-9685-c936530fd326/module/f04cdb21-382e-4588-8950-3b1a29afd2dd/section/c2647acd-7619-4c8a-a7d8-13b452281c35/lesson/99c92a3a-8b45-4428-8ed6-c1c8a7ffdeac) para subir as duas aplicações, garantindo a comunicação de uma com a outra.
